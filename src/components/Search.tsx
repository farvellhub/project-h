    ...
    return (
        <form className="max-w-md mx-auto mb-6">   
            ...
            <div className="relative top-3">
                ...
                <input type="search" className="block w-full p-4 ps-10 text-sm text-gray-900 outline-none rounded-lg shadow bg-gray-100 focus:border-0" placeholder="Search hotels..." required />
